    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 bg-white/5 border border-white/10 p-6 rounded-2xl">
            ...
            <div className="flex-1 flex flex-col gap-2">
              ...
              >
                ...
                <span className="text-gray-400 text-xs">
                  {uploading ? "Uploading..." : "Click to upload new logo image"}
                </span>
        ...
        <div className="flex gap-4 mt-4">
          <button disabled={loading || uploading} type="submit" className="flex-1 bg-[var(--color-accent-secondary)] text-white py-3 rounded-lg hover:opacity-80 transition-opacity font-medium disabled:opacity-50">
