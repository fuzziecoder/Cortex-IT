    ...
    <footer className="bg-[#0a0a0a] border-t border-white/5 relative z-10 w-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-4">
              {/* Instagram */}
              <a href="#" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:text-[#C8F542] hover:border-[#C8F542]/30 transition-all">
      ...
      <div className="border-t border-white/5">
        <div className="container mx-auto px-6 md:px-12 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <Link href="#" className="text-gray-500 hover:text-gray-300 text-xs font-light transition-colors">
            Privacy policy
          </Link>
          <p className="text-gray-500 text-xs font-light text-center">
            © Copyright {year} | Design & Developed By <span className="text-[#C8F542]">Cortex</span> | The Core of Technology.
          </p>
          <Link href="#" className="text-gray-500 hover:text-gray-300 text-xs font-light transition-colors">
            Terms of Use
          </Link>
